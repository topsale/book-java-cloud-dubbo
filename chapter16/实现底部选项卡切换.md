...
<html>
	...
	<body>
		...
		<script src="assets/apps/js/index.js" type="text/javascript" charset="utf-8"></script>
	</body>
...
var Index = function() {
	...
	// 把子页的路径写在数组里面
	var subpages = ['main.html', 'video.html'];

	/**
	 * 初始化首页
	 */
	var handlerInitIndex = function() {
		mui.init();
	 ...
	 * H5+ 操作
	 */
	var handlerPlusReady = function() {
		handlerInitWebview();
		handlerBindChangTabEvent();
	};
	 ...
	 * 绑定选项卡切换事件
	 */
	var handlerBindChangTabEvent = function() {
		// 当前激活选项
